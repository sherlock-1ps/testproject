...
import type { MessageOptions, I18n } from '@lingui/core'
...
export function TransNoContext(
  ...
  const _translation: string = i18n && typeof i18n._ === 'function' ? i18n._(id, values, { message, formats }) : id // i18n provider isn't loaded at all
  ...
  const FallbackComponent: React.ComponentType<TransRenderProps> = defaultComponent || RenderFragment
  ...
  const Component: React.ComponentType<TransRenderProps> = component || FallbackComponent
